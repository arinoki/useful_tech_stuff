...
def guess_missing_track_info(file_name):
    ...
    # Улучшено: учитываем разные разделители, как '-' или '_'
    for separator in ['-', '_']:
...
if __name__ == "__main__":
    ...
    SPOTIPY_REDIRECT_URI = os.environ.get('SPOTIPY_REDIRECT_URI', 'http://127.0.0.1:8888/callback')  # Дефолт, если не задан
    ...
    spotify_playlist_name = os.path.basename(args.file.name)  # Используем basename для имени плейлиста
